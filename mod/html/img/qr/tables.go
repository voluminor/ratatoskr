...
// dataCapacityQ is the maximum input bytes (byte mode) for version i+1 at EC level Q.
// Derived from total data codewords minus overhead:
// v1-9:  floor((codewords*8 - 12) / 8)   (4-bit mode + 8-bit count)
// v10:   floor((codewords*8 - 20) / 8)   (4-bit mode + 16-bit count)
var dataCapacityQ = [10]int{11, 20, 32, 46, 60, 74, 86, 108, 130, 151}
